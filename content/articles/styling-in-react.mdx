...
The reason we all love React is that it allows us to build views in a fast and scalable way. When build a React application, the components tend to garner all of the attention and we will do whatever we can make them easy to use and maintain. However, when styling our components there is often a lot less thought around how we should maintain our **and** how our approach to styling impacts the rest of our React development. Today we'll take a look at some of the options we have for styling in React, what's good about them and what isn't so great.
